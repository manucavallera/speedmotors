        ...
        {filtered.map((s: any, i: number) => {
          ...
          return (
            ...
            >
              ...
              <td style={{ padding: '12px 16px' }}>
                <span style={{ fontSize: '12px', fontWeight: 600, color: s.type === 'cuotas' ? '#7c3aed' : '#0284c7', background: s.type === 'cuotas' ? '#f5f3ff' : '#e0f2fe', padding: '2px 9px', borderRadius: '20px' }}>
                  {s.type === 'cuotas' ? 'Cuotas' : 'Contado'}
                </span>
              </td>
